...
uses
  DataModule, UnitReport;
  

{$R *.dfm}

procedure TFormKustomer.btnSimpanClick(Sender: TObject);
begin
  if edtNik.Text = '' then
  begin
...
procedure TFormKustomer.FormCreate(Sender: TObject);
begin
...
procedure TFormKustomer.btnUbahClick(Sender: TObject);
begin
  if edtNik.Text = '' then
  begin
    ShowMessage('Nik Tidak Boleh Kosong!');
...
procedure TFormKustomer.DBGridCellClick(Column: TColumn);
begin
...
procedure TFormKustomer.btnHapusClick(Sender: TObject);
begin
  if edtNik.Text = '' then
  begin
    ShowMessage('Nik Tidak Boleh Kosong!');
...
procedure TFormKustomer.btnBatalClick(Sender: TObject);
begin
  edtNik.Text := '';
  edtNama.Text := '';
  edtTelp.Text := '';
...
procedure TFormKustomer.btnBaruClick(Sender: TObject);
begin
...
procedure TFormKustomer.cbMemberChange(Sender: TObject);
begin
...
begin
FormReport.frxrprt1.ShowReport();
end;
